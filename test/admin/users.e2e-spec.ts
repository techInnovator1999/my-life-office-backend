...
describe('Users admin (e2e)', () => {
  ...
  it('should Change password for new user: /api/v1/users/:id (PATCH)', () => {
    return request(app)
  ...
  it('should Login via registered user: /api/v1/auth/email/login (POST)', () => {
    return request(app)
      .post('/api/v1/auth/email/login')
  ...
  it('should Fail create new user by admin: /api/v1/users (POST)', () => {
    return request(app)
      .post(`/api/v1/users`)
      .auth(apiToken, {
        type: 'bearer',
  ...
  it('should Success create new user by admin: /api/v1/users (POST)', () => {
    return request(app)
      .post(`/api/v1/users`)
      .auth(apiToken, {
        type: 'bearer',
  ...
  it('should Login via created by admin user: /api/v1/auth/email/login (GET)', () => {
    return request(app)
      .post('/api/v1/auth/email/login')
      .send({
        email: newUserByAdminEmailFirst,
  ...
  it('should Get list of users by admin: /api/v1/users (GET)', () => {
    return request(app)
      .get(`/api/v1/users`)
      .auth(apiToken, {
        type: 'bearer',
