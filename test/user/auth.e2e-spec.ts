...
describe('Auth user (e2e)', () => {
  ...
  it('should login: /api/v1/auth/email/login (POST)', () => {
    return request(app)
  ...
  it('should not allow register user with exists email: /api/v1/auth/email/register (POST)', () => {
    return request(app)
  ...
  it('should register new user: /api/v1/auth/email/register (POST)', async () => {
    return request(app)
      .post('/api/v1/auth/email/register')
      .send({
        email: newUserEmail,
  ...
  it('should login unconfirmed user: /api/v1/auth/email/login (POST)', () => {
    return request(app)
      .post('/api/v1/auth/email/login')
  ...
  it('should confirm email: /api/v1/auth/email/confirm (POST)', async () => {
  ...
  it('should not confirm email with same link twice: /api/v1/auth/email/confirm (POST)', async () => {
    const hash = await request(mail)
      .get('/email')
      .then(({ body }) =>
        body
  ...
  it('should login confirmed user: /api/v1/auth/email/login (POST)', () => {
    return request(app)
      .post('/api/v1/auth/email/login')
      .send({ email: newUserEmail, password: newUserPassword })
      .expect(200)
  ...
  it('should refresh token: /api/v1/auth/refresh (GET)', async () => {
